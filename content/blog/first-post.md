...
This portfolio site is built with Go and uses a custom post management system. Each post is written in Markdown with
YAML frontmatter for metadata. It's a lightweight approach that keeps things simple and performant.

## Let's Connect

If you find something interesting or want to discuss ideas, feel free to reach out. I'm always interested in connecting
with other developers and hearing about what you're working on.
