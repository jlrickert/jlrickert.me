...
func TestAssetsContainsDataYAML(t *testing.T) {
	...
	_, err := fs.Stat(Assets, "data/data.yaml")
...
func TestAssetsContainsPosts(t *testing.T) {
	...
	entries, err := fs.ReadDir(Assets, "data/posts")
	...
	_, err = fs.Stat(Assets, "data/posts/first-post.md")
...
func TestAssetsDataYAMLIsReadable(t *testing.T) {
	...
	data, err := fs.ReadFile(Assets, "data/data.yaml")
...
func TestAssetsFirstPostIsReadable(t *testing.T) {
	...
	postContent, err := fs.ReadFile(Assets, "data/posts/first-post.md")
	require.NoError(t, err, "should be able to read first-post.md")
